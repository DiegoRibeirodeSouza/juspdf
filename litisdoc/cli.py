...
from litisdoc.tui import run_tui

from litisdoc.commands import compress, split_merge, rotate, extract, ocr, convert, search, resurrect, impose, sign, verify, dossier

app = typer.Typer(
    help="litisdoc - Canivete suíço para manipulação de PDFs no Linux.",
    no_args_is_help=False
)

console = Console()

# Registrando os subcomandos na raiz do app para acesso direto (ex: litisdoc merge)
