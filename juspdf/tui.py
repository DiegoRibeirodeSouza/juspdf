...
from juspdf.backends.poppler import extract_text, extract_images, get_info, render_to_images
from juspdf.backends.qpdf import merge_pdfs, split_pdf, rotate_pdf, encrypt_pdf, decrypt_pdf, linearize_pdf
from juspdf.backends.ocrmypdf import apply_ocr, convert_to_pdfa
from juspdf.backends.img2pdf import convert_images_to_pdf
from juspdf.backends.metadata import clear_metadata
from juspdf.backends.watermark import add_watermark, add_pagination
from juspdf.backends.diff import compare_pdfs
from juspdf.backends.sign import sign_with_a3
from juspdf.backends.imposition import create_booklet
from juspdf.backends.resurrect import scrub_pdf
from juspdf.backends.search import search_in_pdfs
from juspdf.backends.verify import verify_signatures

console = Console()

def run_tui():
    console.print("\n[bold green]=== Bem-vindo ao JusPDF Interativo ===[/bold green]\n")
